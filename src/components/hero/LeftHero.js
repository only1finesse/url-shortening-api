...
const LeftHero = () => {
    return (
        <div className='heroSection flex-wrap'>
            ...
            <div className='py-12'>
                <Link className='text-3xl md:text-xl bg-primaryCyan text-white px-7 py-3 rounded-full hover:brightness-110 duration-400 transition-all' href='/'>Get Started</Link>
            </div>
        </div>
    )
}
